          ...
          <SafeAreaView style={styles(props.orientation).container}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <Animated.View style={[styles(props.orientation).inner,{top : moveAnim,opacity : fadeAnim}]}>
                ...
                <InputBoxLogin  onChangeText={handleID} placeholder="ID Number" icon="number" size={{hp:hp('6%'),wp:wp('50%')}}/>
                             
                <InputBoxLogin text={username} onChangeText={handleUser} placeholder="Username" icon="user" size={{hp:hp('6%'),wp:wp('50%')}}/>
                <InputBoxLogin text={password} onChangeText={handlePassword} placeholder="Password" icon="key" size={{hp:hp('6%'),wp:wp('50%')}} password={true}/>
               
                <InputBoxLogin  onChangeText={handleName} placeholder="Name" icon="user" size={{hp:hp('6%'),wp:wp('50%')}}/>
                <InputBoxLogin onChangeText={handleSurname} placeholder="Surname" icon="key" size={{hp:hp('6%'),wp:wp('50%')}}/>
