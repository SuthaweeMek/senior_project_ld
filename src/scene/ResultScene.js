            ...
            <View style={styles({orientation}).containerResult  }>
                ...
                <View style={styles({orientation}).containerinfoPersonal}>
                    <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles({orientation}).textInfoPersonal}>พยัญชนะ : {orientation=="portrait"?"\n\n":null}เขียนถูก 30 ตัว <Text style={{ color: Color.Correct }}>เขียนผิด</Text> 10 ตัว <Text style={{ color: Color.Wrong }} >เขียนกลับด้าน</Text> 4 ตัว</Text>
                        <Text style={styles({orientation}).textInfoPersonal}>สระ : {orientation=="portrait"?"\n\n":null}เขียนถูก 30 ตัว <Text style={{ color: Color.Correct  }}>เขียนผิด</Text> 10 ตัว <Text style={{ color: Color.Wrong  }} >เขียนกลับด้าน</Text> 4 ตัว</Text>
                        <Text style={styles({orientation}).textInfoPersonal}>คำสะกด : {orientation=="portrait"?"\n\n":null}เขียนถูก 7 ตัว <Text style={{ color: Color.Correct  }}>เขียนผิด</Text> 2 ตัว <Text style={{ color: Color.Wrong  }} >เขียนกลับด้าน</Text> 1 ตัว</Text>
                    </View>
            ...
            <>
                <View style={styles({orientation}).container}>
                    <View style={styles({orientation}).containerResult}>   
                        ...
                        {paging < 3.2? <TouchableOpacity  onPress={()=>{setPaging(paging+1)} } style={styles({orientation}).buttonPagination} >
